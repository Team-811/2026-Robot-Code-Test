...
// public class sideC_L1x2 extends ParallelCommandGroup {
//   /** Creates a new cL4x2. */
...
//   public sideC_L1x2(Elevator el, CommandSwerveDrivetrain drivetrain, rollerClaw rolly, String path,cArm coArm) {
...
//      ).ignoringDisable(true),new cUpAuto(coArm)), new slowRolly(rolly), new PathPlannerAuto("midL4x2"), new ParallelDeadlineGroup(new WaitCommand(3),drivetrain.applyRequest(()->robotCentric
//      .withVelocityX(slewLimY.calculate(limeY())*MaxSpeed)
//      .withVelocityY(slewLimX.calculate(limeX())*MaxSpeed)
//      .withRotationalRate(slewLimRoteLime.calculate(limeYaw())/60)
//      ).ignoringDisable(true), new cMid(coArm), new reverseIntakeCommand(rolly)));
//   }
//   public double limeX(){
