...
public class cL4x1 extends SequentialCommandGroup {
  ...
  public cL4x1(Elevator el, CommandSwerveDrivetrain drivetrain, cClaw claw, String path) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    // addCommands(new PathPlannerAuto(path), new toL4(el).andThen(new InstantCommand(()->claw.solenoidToggle())));
    addCommands(new PathPlannerAuto("midL4x1"), new toL4(el).andThen(new InstantCommand(()->claw.solenoidToggle())));
  }
}
